...
its own disntict entity and by default most things are kept out of sight unless you need to gain access to them for some 
specific purpose. 
...
Ultimately, however, I would like the site to have a bit more of its own distinct look and style. I already have a few 
potential directions that would take it up a notch and give it more of the appeal that I'm after. The only issue is that
deciding on which one of these approaches to take will require more time and experimentation. As I don't like holding 
back on releasing things for the purpose of fitting extra features in, I decided to just go with what I have for now
and improve it later when the details are settled.
