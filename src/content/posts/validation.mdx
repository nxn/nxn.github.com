...
<a href="https://en.wikipedia.org/wiki/Whitespace_%28programming_language%29" target="_blank" rel="noreferrer">
whitespace</a> code. So why is it that this is the default behavior of so many `required` flags in this day and age?
What practical purpose does this flag even serve? 
...
<a href="https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/pattern#Accessibility_Concerns" target="_blank"
rel="noreferrer">MDN</a>